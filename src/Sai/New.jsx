...
const Address = () => {
  ...
  const bindHandler = (value) => {
    setBind({ upload: value });
  };
  ...
  const validate = (values) => {
    ...
    if (!values.file) {
      errors.file = "UPLOAD THE SELECTED IDENTIFICATION FILE";
    }
    return errors;
  };
      ...
      <form onSubmit={submitHandler}>
        <div className="container mt-5">
          <center>
            ...
            with few of your personal details for identity verification. Please
            do not use a PO Box
          </center>
          ...
          <div className="row mt-5">
            <div className="col-md-6">
              <div className="form-group">
                {/* <input type="text" className="a b form-control"  placeholder="Mailng Address Line 1" name="line1" onChange={updateHandler}/> */}
                {/* <fieldset className="form-control" style={{"margin-left":"10px;"}}>
                        <legend>ola 9sai<input type="text" className="a b form-control"  name="line1" onChange={updateHandler}/>
                    </legend>
                    </fieldset> */}
                <fieldset class="form-group border p-3">
                  <legend class="w-auto px-2">Mailng Address Line 2</legend>
                  <input
                    type="text"
            ...
            <div className="col-md-6">
              <div className="form-group">
                <input
                  ...
                  placeholder="Mailng Address Line 2"
                  name="line2"
                  onChange={updateHandler}
                />
            ...
            <div className="col-md-3">
              <div className="form-group">
                <input
                  type="number"
                  className="form-control"
                  placeholder="Social Security Last 4"
                  name="social"
                  onChange={updateHandler}
                />
                  ...
                  <div className="col-md-2">
                    <div>
                      <input
                        ...
                        name="gridRadios"
                        value="text"
                        onClick={bindHandler.bind(
                          this,
                          "UPLOAD DRIVER LISENCE"
                        )}
                        onChange={updateHandler}
                      />
                      Driver's Licence
                  ...
                  <div className="col-md-2">
                    <div>
                      <input
                        ...
                        name="gridRadios"
                        value="text"
                        onClick={bindHandler.bind(this, "UPLOAD PASSPORT")}
                        onChange={updateHandler}
                      />
                      Passport
                      <span>{formerror.gridRadios}</span>
            ...
            <div className="form-group col-md-12">
              <center className="mt-1">
                <pre
                  ...
                  type="file"
                >
                  {JSON.stringify(bind.upload)}
                </pre>
                {/* <input type="text" name="file" style={{"width":"300px" , "height":"50px"}} placeholder="Upload Identification File"/> */}
            ...
            {/* <div>
                <fieldset className="a b" style={{"margin-left":"10px;"}}>
    <legend class="reset-this redo-legend">9sai in ola</legend>
</fieldset></div> */}
            {/* <div className="form-group">
<fieldset className="a b form-control" type="text" placeholder="Mailing Address Line 1" name="line1" onChange={updateHandler} style={{"margin-left":"10px;"}}>
    <legend class="reset-this redo-legend">Mailing Address Line 1</legend>
</fieldset>
</div>
...
<input type="text" className="a form-control"  placeholder="Mailng Address Line 2" name="line2" onChange={updateHandler}/>
